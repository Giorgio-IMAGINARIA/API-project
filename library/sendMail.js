    ...
    return new Promise(
        function (resolve, reject) {
            ...
            var mailOptions = {
                ...
                html: "<!DOCTYPE html><html lang='en'><head><meta charset='utf-8'><title>Email form test</title></head><body>Hello,<br> Please Click on the link to verify your email.<br><a href="+link+">click here</a><form id='verificationForm' method='post' action="+link+"></form><button type='submit' form='verificationForm' value='Submit'>Confirm</button></body></html>"
            };
